...
public class Test08{
  ...
  public static void main(String[]args){
    ...
    if(Arrays.equals(start,result)){
      System.out.println(elapsedTime/1000.0+"sec PASS Mergesort Case "+arg+". "+name(type)+" array, size:"+size);
    }else{
      System.out.println("   ERROR! Case "+arg+" ERROR! "+name(type)+" array, size:"+size+"  ERROR!");
    }
  }
